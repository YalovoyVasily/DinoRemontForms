...
namespace DinoRemont
{
    public class Configuration_class
    {
        ...
        public void SQL_Server_Configuration_Get()
        {
            ...
            RegistryKey key = registry.CreateSubKey("Server_Configuration_DinoRemont");
            try
            {
        ...
        public void SQL_Data_Base_Collection()
        {
            ...
            SqlCommand command = new SqlCommand("select name from sys.databases " +
                ...
                "and name like 'Dino_Remont_DB%'", connection);
        ...
        private List<string> Get_Remoute_Machine_Name()
        {
            try
            {
            
                List<string> new_ip_list = new List<string>();
                foreach (NetworkInterface netInterface in NetworkInterface.GetAllNetworkInterfaces())
                {
                    ...
                    {
                        new_ip_list.Add(addr.Address.ToString());
                    }
                }
                    return new_ip_list;
            }
        ...
        public static string Organization_Name = "DinoRemont", 
        ...
        public void Document_Configuration_Get()
        {
            ...
            RegistryKey key 
                = registry.
                CreateSubKey("Server_Configuration_DinoRemont");
            try
            {
                Organization_Name 
