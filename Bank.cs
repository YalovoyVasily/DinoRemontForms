...
namespace DinoRemont
{
    public partial class Bank : Form
    {
        ...
        String Query = DBConnection.qrBank;
        ...
        private void Button_Add_Click(object sender, EventArgs e)
        {
            ...
            procedure.procedure_Execution("Bank_insert", array);
        ...
        private void Button_Correct_Click(object sender, EventArgs e)
        {
            ...
            procedure.procedure_Execution("Bank_update", array);
            Employee_Load(sender, e);
        }
        ...
        private void CheckBox_Filter_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                case (true):
                    dgvFill(Query + string.Format("where [Name_Bank] like '%{0}%' " +
                                "or" + "[BIK_Bank] like '%{0}%' " +
                                "or" + "[KOR_Bank] like '%{0}%'", TextBox_Search.Text), DataGridView_Employee);
                    break;
                case (false):
                    dgvFill(Query, DataGridView_Employee);
                    break;
