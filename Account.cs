...
namespace DinoRemont
{
    public partial class Account : Form
    {
        ...
        String Query = DBConnection.qrAccount;
        ...
        private void Button_Add_Click(object sender, EventArgs e)
        {
            ...
            procedure.procedure_Execution("Account_insert", array);
        ...
        private void Button_Correct_Click(object sender, EventArgs e)
        {
            ...
            procedure.procedure_Execution("Account_update", array);
            Employee_Load(sender, e);
        }
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
            {
                ...
                ArrayList array = new ArrayList();
                array.Add(ID_Record);
                procedure.procedure_Execution("Account_delete", array);
                //Проверка на существование записи после "удаления"
                Function_Class function = new Function_Class();
                function.Record_Checking(ID_Record, "Account");
                Employee_Load(sender, e);
            }
        ...
        private void CheckBox_Filter_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                case (true):
                    dgvFill(Query + string.Format("where [Login_Account] like '%{0}%' " +
                                "or" + "[Password_Account] like '%{0}%'", TextBox_Search.Text), DataGridView_Employee);
                    break;
                case (false):
                    dgvFill(Query, DataGridView_Employee);
                    break;
