...
namespace DinoRemont
{
    public partial class Position : Form
    {
        ...
        String Query = DBConnection.qrPosition;
        ...
        private void Button_Add_Click(object sender, EventArgs e)
        {
            ...
            procedure.procedure_Execution("Position_insert", array);
        ...
        private void Button_Correct_Click(object sender, EventArgs e)
        {
            ...
            procedure.procedure_Execution("Position_update", array);
            Employee_Load(sender, e);
        }
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
            {
                ...
                ArrayList array = new ArrayList();
                array.Add(ID_Record);
                procedure.procedure_Execution("Position_delete", array);
                //Проверка на существование записи после "удаления"
                Function_Class function = new Function_Class();
                function.Record_Checking(ID_Record, "Position");
                Employee_Load(sender, e);
            }
        ...
        private void CheckBox_Filter_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                case (true):
                    dgvFill(Query + string.Format("where [Name_Position] like '%{0}%' " +
                                "or" + "[Salary] like '%{0}%'", TextBox_Search.Text), DataGridView_Employee);
                    break;
                case (false):
                    dgvFill(Query, DataGridView_Employee);
                    break;
