...
namespace DinoRemont
{
    public partial class Employee : Form
    {
        ...
        String Query = DBConnection.qrEmployee;
        ...
        private void Button_Delete_Click(object sender, EventArgs e)
        {
            ...
            if(result == DialogResult.Yes)
            {
                ...
                function.Record_Checking(ID_Record, "Employee");
                Employee_Load(sender, e);
            }
        ...
        private void CheckBox_Filter_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                case (true):
                    dgvFill(Query + string.Format("where [Employee_Last_Name] like '%{0}%' " +
                                "or" + "[Employee_Name] like '%{0}%' " +
                                "or" + "[Employee_Middle_Name] like '%{0}%' " +
                                "or [Employee_Login] like '%{0}%'" +
                                "or [Employee_Password] like '%{0}%'" +
                                "or [Post_Name] like '%{0}%'", TextBox_Search.Text), DataGridView_Employee);
                    break;
                case (false):
                    dgvFill(Query, DataGridView_Employee);
                    break;
